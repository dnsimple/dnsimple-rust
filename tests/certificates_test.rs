...
fn test_list_certificates() {
    ...
    let response = client.certificates().list_certificates(account_id, domain, None).unwrap();
...
fn test_get_certificate() {
    ...
    let certificate = client.certificates().get_certificate(account_id, domain, certificate_id).unwrap().data.unwrap();
...
fn test_download_certificate() {
    ...
    let download = client.certificates().download_certificate(account_id, domain, certificate_id).unwrap().data.unwrap();
...
fn test_get_certificate_private_key() {
    ...
    let certificate_private_key = client.certificates().get_certificate_private_key(account_id, domain, certificate_id).unwrap().data.unwrap();
...
fn test_purchase_letsencrypt_certificate() {
    ...
    let letsencrypt = client.certificates().purchase_letsencrypt_certificate(account_id, domain, payload).unwrap().data.unwrap();
...
fn test_issue_letsencrypt_certificate() {
    ...
    let certificate = client.certificates().issue_letsencrypt_certificate(account_id, domain, certificate_id).unwrap().data.unwrap();
...
fn test_purchase_letsencrypt_certificate_renewal() {
    ...
    let letsencrypt_renewal = client.certificates().purchase_letsencrypt_certificate_renewal(account_id, domain, certificate_id, payload).unwrap().data.unwrap();
...
fn test_issue_letsencrypt_certificate_renewal() {
    ...
    let renewal = client.certificates().issue_letsencrypt_certificate_renewal(account_id, domain, certificate_id, certificate_renewal_id).unwrap().data.unwrap();
